    ...
    const mockRecipes: Recipe[] = [
      {
        ...
        cookTime: '20分钟',
        difficulty: '简单',
        image: 'https://placehold.co/400x300?text=健康蔬菜炒饭',
        isVegetarian: true,
      ...
      },
      {
        ...
        cookTime: '30分钟',
        difficulty: '中等',
        image: 'https://placehold.co/400x300?text=香煎三文鱼',
        isVegetarian: false,
      ...
      },
      {
        ...
        cookTime: '15分钟',
        difficulty: '简单',
        image: 'https://placehold.co/400x300?text=番茄鸡蛋面',
        isVegetarian: false,
        isBeginnerFriendly: true,
      },
      {
        ...
        cookTime: '10分钟',
        difficulty: '简单',
        image: 'https://placehold.co/400x300?text=素食沙拉',
        isVegetarian: true,
        isBeginnerFriendly: true,
      },
    ];
